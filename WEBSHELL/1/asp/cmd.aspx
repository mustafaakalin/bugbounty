<%@ Language = "JScript" %>
<%
  var version = "v1.0 [01-01-2021]";
  var homepagelink = "https://ren4sploit.com";
...
<div id="output">
  <div id="greeting">
    ...
    <font color=#CCCCCC face=webdings size=5 >!</font>Copyright &copy; 2021 Ren4Sploit<font color=#CCCCCC face=webdings size=5 >!</font><a href="<%=homepagelink%>"><%=homepagelink%></a><br/><br/>
  </div>
</div>
